...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView ID="SuppliersListView" runat="server"
        ...
        <InsertItemTemplate>
            <tr>
                        <td> <asp:LinkButton ID="AddSupplier" runat="server" CssClass="btn btn-success glyphicon glyphicon-plus" CommandName="Insert">Add</asp:LinkButton></td>
                        <td><asp:TextBox ID="CompanyName" runat="server" Text="<%BindItem.CompanyName %>"
                             placeholder="Enter company name: ">
                            </asp:TextBox>
                        </td>
                        <td><asp:TextBox ID="Contact" runat="server" Text="<%BindItem.ContactName%>" placeholder="Contact name"></asp:TextBox>
                        ...
                        <%--<td><asp:TextBox ID="address" runat="server" Text="<%BindItem.Email %>" placeholder="Email"></asp:TextBox></td>--%>
                        <td><asp:TextBox ID="Phone" runat="server" Text="<%BindItem.Phone%>" TextMode="Phone" placeholder="Phone #"></asp:TextBox>
                        <td><asp:TextBox ID="Fax" runat="server" Text="<%BindItem.Fax%>" placeholder="Fax #"></asp:TextBox></td>
                    </tr>
        </InsertItemTemplate>
