...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:ListView runat="server" ID="AddressListView" DataSourceID="AddressDataSource" DataKeyNames="AddressID" InsertItemPosition="FirstItem">
        <EditItemTemplate>
            <tr style="">
                <td>
 ...
 <asp:ObjectDataSource ID="AddressDataSource" runat="server" DataObjectTypeName="WestWindSystem.Entities.Address" DeleteMethod="DeleteAddress"
     InsertMethod="AddAddress" OldValuesParameterFormatString="original_{0}" SelectMethod="ListAddresses"
     TypeName="WestWindSystem.BLL.CRUDController" UpdateMethod="UpdateAddress" OnInserted="CheckForExceptions" OnUpdated="CheckForExceptions"
